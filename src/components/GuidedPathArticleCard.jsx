...
function GuidedPathArticleCard({content,reloadArticleList,guidedPathTitle}) {

    const {username,jwtToken} = useContext(AuthContext);
    const [showDeleteModal,setShowDeleteModal] = useState(false);
    const backendEndpoint = `http://localhost:8080/admin/${guidedPathTitle}/${content}/delete-article`;
...
export default GuidedPathArticleCard
