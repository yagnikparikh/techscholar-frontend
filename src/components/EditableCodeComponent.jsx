...
function EditableArticleCodeComonent({ articleData, handelEdit }) {
                            ...
                            <div className='bg-gray-700 rounded'>
                                ...
                                <div className="card">
                                    <div className="card-body bg-gray-700 rounded">
                                        <p className="text-white text-xs font-bold mb-2 text-left mt-0">Code Comonent</p>
                                        <hr className="bg-white" />
...
export default EditableArticleCodeComonent
