...
function GuidedPathArticleDisplay() {

    const { jwtToken, username } = useContext(AuthContext);
    const { guidedPathTitle, articleHeading } = useParams();
    ...
    const fetchAritcle = () => {
        ...
        fetch(`http://localhost:8080/${guidedPathTitle}/${articleHeading}`, {
            method: "GET",
            headers: {
            ...
            .then(data => {
                ...
                console.log(data);
                setArticle(data);
                setArticleDataList(data.guidedPathArticleDataList);
            })
    ...
    const handelEdit = (articleDataId, contentType, contentData) => {
        ...
        const backendEndpoint = `http://localhost:8080/admin/${guidedPathTitle}/${articleHeading}/update-article-data`;
    ...
    const handelDelete = (articleData) => {
        ...
        console.log("data to be sent : ");
        console.log(articleData);
        const backendEndpoint = `http://localhost:8080/admin/${guidedPathTitle}/${articleHeading}/delete-article-data`;
    ...
    const handelAddNew = (articleData) => {
        ...
        console.log("data to be sent : ");
        console.log(articleData);
        const backendEndpoint = `http://localhost:8080/admin/${guidedPathTitle}//${articleHeading}/add-article-data`;
...
export default GuidedPathArticleDisplay
