...
function ArticleGroupCard({content,reloadArticleGroupList}) {

    const {username,jwtToken} = useContext(AuthContext);
    const [showDeleteModal,setShowDeleteModal] = useState(false);
    const backendEndpoint = `http://localhost:8080/mentors/${username}/${content}/delete-articlegroup`;
