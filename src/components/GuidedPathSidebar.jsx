                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    {sidebarItems.map((item, index) => (
                        <li className='nav-item' key={index}>
                            <a href={`/${username}/admin/my-${item.substring(3).toLowerCase()}`} class="nav-link text-left" aria-current="page" style={navLinkStyle.base}
                                onMouseOver={(e) => {
...
export default GuidedPathSidebar;
